...
extension TVShowListViewController: UISearchControllerDelegate, UISearchBarDelegate, UISearchDisplayDelegate {
    ...
    func searchBarSearchButtonClicked(_ searchBar: UISearchBar) {
            self.router.defaultMediaList(for: searchBar.text!, with: .tvshows, on: self)
    }
}
